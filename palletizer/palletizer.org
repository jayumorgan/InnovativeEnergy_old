...
*** TODO Clicking the empty save outside the config screen should not close the configuration screen. Use "x" at top right corner
...
*** TODO Make sure the e-stop will not stop the gripper from functioning
