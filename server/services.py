...
class RuntimeService:
    ...
    def __init__(self):
        ...
        self.__machineAppArguments = None
        self.__logger = logging.getLogger(__name__)
    ...
    def __primaryThreadLoop(self):
        ...
        while True:
            if self.__requestRunMachineApp:
                self.machineApp = MachineAppEngine(self.__machineAppArguments[0], self.__machineAppArguments[1])
                self.__requestRunMachineApp = False
    ...
    def run(self, configurationType, configurationId):
        ...
        self.__machineAppArguments = (configurationType, configurationId)
